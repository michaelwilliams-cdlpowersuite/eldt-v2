...
import FormikSelectWithCheckmarks from "../../registration/components/FormikSelectWithCheckmarks";
import { referralSourcesOptions, workTypes } from "../../registration/utilities/optionsLists";
import { pxContainer, titleStyles } from "../../registration/utilities/styles";
import { AttributeName } from "../../registration/utilities/customAttributes";
...
const CheckoutStep3: React.FC<CheckoutStep3Props> = () => {
